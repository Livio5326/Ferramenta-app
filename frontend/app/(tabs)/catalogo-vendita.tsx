...
export default function CatalogoVenditaScreen() {
...
const loadMore = useCallback(async () => {
  ...
  const renderCard = useCallback(
      ...
      return (
        ...
        >
          ...
          <View style={styles.cardBody}>
            ...
            {(isCliente || soloVendita) ? (
              <AppButton
                style={styles.addButton}
                onPress={(event) => {
                  event.stopPropagation();
                  addToCart?.({ ...item, id: getProductId(item),});
                  Alert.alert("Vendita", "Prodotto aggiunto alla vendita.");
                }}
              >
                <Text style={styles.addButtonText}>{soloVendita ? "VENDI" : "AGGIUNGI"}</Text>
              </AppButton>
            ) : null}
          </View>
        </AppButton>
    ...
    [addToCart, isCliente, soloVendita]
  );

  const headerSubtitle = useMemo(() => {
    if (catalogoFiltratoDaPagina) return categoriaDaPagina;
    if (categoria) return categoria;
    return "Scegli prodotto per la vendita";
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.header}>
        <View>
          <Text style={styles.title}>Catalogo vendita</Text>
