...
export default function FornitoriScreen() {
  ...
  async function anteprimaImport() {
    ...
    try {
      setLoading(true);
      const res = await api.previewPromoImport(file);
      setPreview(res);
    } catch (err: any) {
      ...
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Gestione cataloghi, grossisti e promozioni.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          <Text style={styles.cardTitle}>Disattiva promozioni</Text>
          <Text style={styles.cardText}>
            Disattiva tutte le promo attive senza cancellare i prezzi standard.
          </Text>
          <TouchableOpacity style={styles.dangerButton} onPress={disattivaPromo} disabled={loading}>
            <Text style={styles.buttonText}>DISATTIVA PROMO</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </SafeAreaView>
