      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        >
          ...
          <Text style={styles.importPromoToggleText}>
            {importPromoOpen ? 'Chiudi importazione' : 'Importa promozione'}
          </Text>
        </TouchableOpacity>
        ...
        <View style={styles.card}>
          <Text style={styles.cardTitle}>Promozioni attive</Text>
          <Text style={styles.cardText}>
            Prima scegli la promozione, poi vedi i prodotti contenuti.
          </Text>
          ...
          {activePromos && (
            <>
              ...
              {activePromos.riepilogo?.length === 0 && (
                <Text style={styles.cardText}>Nessuna promozione attiva.</Text>
              )}
              ...
              {activePromos.riepilogo?.map((p: any, index: number) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Text style={styles.productText}>Prodotti: {p.prodotti}</Text>
                    <Text style={styles.productText}>Attivi: {p.prodotti_attivi}</Text>
                    <Text style={styles.productText}>Stato: {p.attiva ? 'ATTIVA' : 'DISATTIVATA'}</Text>
                    <Text style={styles.productText}>Inizio: {p.promo_inizio || '-'}</Text>
                    <Text style={styles.productText}>Fine: {p.promo_fine || '-'}</Text>
                  ...
                  {activePromos.prodotti
                    ...
                    .map((p: any, index: number) => (
                      <View key={`${p.id}-${index}`} style={styles.productRow}>
                        ...
                        <Text style={styles.productText}>Stato: {p.promo_attiva ? 'ATTIVA' : 'DISATTIVATA'}</Text>
